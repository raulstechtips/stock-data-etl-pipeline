...
![Architecture placeholder](docs/Stock%20ETL%20Data%20Pipeline%20Architecture%20-%20Final.png)
...
1. Clone the repo:
   ```bash
   git clone git@github.com:your-org/stock-data-etl-pipeline.git
   ```
2. Open the directory and start the recommended dev container:
   ```bash
   cd /workspace/stock-data-etl-pipeline
   ```
